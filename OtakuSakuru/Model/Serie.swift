...
struct Serie: Identifiable, Equatable, Codable {
...
enum Category: String, Identifiable, Codable {
    var id: Self {
            return self
        }
...
extension Serie {
    static var example: [Serie] = [
        Serie(title: "Naruto",
              ...
              books: Manga.example.filter({ $0.title == "Naruto" })),

        Serie(title: "One Piece",
              ...
              books: Manga.example.filter({ $0.title == "One Piece" })),

        Serie(title: "Hokuto No Ken",
              imageLogoName: "OnePieceLogoColor",
              imagesDrawName: [],
              ...
              releaseStatus: .inProgress,
              books: Manga.example.filter({ $0.title == "Hokuto No Ken" })),

        Serie(title: "Fire force",
              ...
              kinds: [.action, .comedy, .adventure],
              releaseStatus: .inProgress,
              books: Manga.example.filter({ $0.title == "Fire force" })),

        Serie(title: "One-Punch Man",
              ...
              kinds: [.action, .comedy, .adventure],
              releaseStatus: .inProgress,
              books: Manga.example.filter({ $0.title == "One-Punch Man" }))
